...
24. c4.5 是什么？
    ...
    答：信息增益容易倾向选择取值多的属性，所以 c4.5 是利用信息增益比的决策树。
...
29. 当数据线性可分、接近线性可分以及线性不可分时，分别使用什么 SVM？
...
38. 给一组数据，问决策树、LR、NB 以及 SVM 等算法学出来是什么样子的？
...
51. 上溢和下溢是什么，softmax 函数会出现哪种情况，该怎么解决？
...
52. 讲一下 EM 算法，E 步和 M 步的具体步骤，E 中的期望是什么？
...
77. sgd、momentum、rmsprop、adam 区别与联系
...
95. CNN 在卷积和池化过程中，输入特征和输出特征的关系是怎样的？
...
124. Glove 和 LSA 有什么联系或区别？

     答：LSA  采用计算复杂度高的 SVD 算法，Glove 可看作是对 LSA 的一种优化。

125. Glove 和 word2vec 有什么联系或区别？
...
132. Transformer 的 position encoding 为什么选三角函数？
...
134. Transformer 使用的时候，制约显存的最关键因素是什么？
...
153. max pooling 和 mean pooling 是什么？有其他方式吗？
