...
102. Glove 和 LSA 有什么联系或区别？

     答：LSA  采用计算复杂度高的 SVD 算法，Glove 可看作是对 LSA 的一种优化。

103. Glove 和 word2vec 有什么联系或区别？
...
110. Transformer 的 position encoding 为什么选三角函数？
...
112. Transformer 使用的时候，制约显存的最关键因素是什么？
...
131. max pooling 和 mean pooling 是什么？有其他方式吗？
