...
16. 共 10 瓶药丸。（1）其中一瓶每颗超重 10 毫克；（2）其中多瓶每颗超重 10 毫克。用最少称重数目给出错误的瓶号。
...
33. 给一组数据，问决策树、LR、NB 以及 SVM 等算法学出来是什么样子的？
...
40. 上溢和下溢是什么，softmax 函数会出现哪种情况，该怎么解决？
...
41. 讲一下 EM 算法，E 步和 M 步的具体步骤，E 中的期望是什么？
...
54. Boosting 的工作机制是什么？

    答：通过基学习器的表现对训练样本分布进行调整，使得分错样本得到更多关注。

55. Random Forest 是什么？
...
61. sgd、momentum、rmsprop、adam 区别与联系
...
103. Glove 和 LSA 有什么联系或区别？

     答：LSA  采用计算复杂度高的 SVD 算法，Glove 可看作是对 LSA 的一种优化。

104. Glove 和 word2vec 有什么联系或区别？
...
111. Transformer 的 position encoding 为什么选三角函数？
...
113. Transformer 使用的时候，制约显存的最关键因素是什么？
...
132. max pooling 和 mean pooling 是什么？有其他方式吗？
