...
![Activity生命周期](/redant/img/activity-lifecycle.gif)
...
![Fragment生命周期](/redant/img/fragment-lifecycle.png)

![Fragment与Activity生命周期对比图](/redant/img/lifecycle-comparison.png)
